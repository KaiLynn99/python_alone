...
`Phone` を右クリック →「**列の分割**」→「**区切り記号による分割**」

<img src="images/image-40.png" width="250">

##### - 結果

<img src="images/image-41.png" width="400">

##### - 再結合

`Ctrl` を押しながら3つの列を選択 → 右クリック →「**列のマージ**」

<img src="images/image-42.png" width="250">

##### - 結果

<img src="images/image-43.png" width="150">
...
<img src="images/image-46.png" width="250">

##### - データ型の変更

`ZipCode` が整数型（右揃え）の状態で右クリック  
→「**型の変更**」→「**テキスト**」

→ テキスト型に変更すると左揃えになる。

<img src="images/image-47.png" width="250">
...
<img src="images/image-48.png" width="200">
...
例：`Sales` が `5000` より大きい場合は `VIP`、それ以外は `一般` とする。

![alt text](images/image-49.png)

##### - 結果

<img src="images/image-50.png" width="150">
...
「**列の追加**」タブ →「**例からの列**」→「**選択範囲から**」

`CustomerName` を選択し、いくつかの変換例を入力すると、Power Query がパターンを推測して残りの値を自動生成する。

<img src="images/image-52.png" width="150">

→ 先頭の1文字を残し、それ以降の文字を `x` に置き換える。
...
「**ホーム**」タブ →「**パラメーターの管理**」→「**新しいパラメーター**」

<img src="images/image-53.png" width="350">


→ 作成したパラメーター `x` は、値を直接入力する代わりに条件として使用できる。

##### - 確認

<img src="images/image-54.png" width="300">

##### - 使用

`UnitPrice` 列 → 数値フィルター →「**より大きい**」

<img src="images/image-55.png" width="350">

##### - 結果

<img src="images/image-56.png" width="150">
